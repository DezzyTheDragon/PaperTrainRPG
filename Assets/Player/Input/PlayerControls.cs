...
public partial class @PlayerControls: IInputActionCollection2, IDisposable
{
    ...
    ""controlSchemes"": []
        ...
        m_UINav_navigation = m_UINav.FindAction("navigation", throwIfNotFound: true);
    ...
    private readonly InputAction m_UINav_navigation;
    private readonly InputAction m_UINav_confirm;
    private readonly InputAction m_UINav_back;
    public struct UINavActions
    {
        private @PlayerControls m_Wrapper;
        public UINavActions(@PlayerControls wrapper) { m_Wrapper = wrapper; }
        public InputAction @navigation => m_Wrapper.m_UINav_navigation;
